...
class MediumProvider(BaseScraperProvider):
    def __init__(self):
        super().__init__(platform_name="medium", site_domain="medium.com/", result_pattern="medium.com/@")
    ...
    def search(
        ...
        queries = [f'site:medium.com/@ "{role}"', f'site:medium.com/@ "{role}" "{loc}"']
        ...
        for q in queries:
            ...
            try:
                ...
                print(f"DEBUG: Oxylabs Medium exception: {e}")
