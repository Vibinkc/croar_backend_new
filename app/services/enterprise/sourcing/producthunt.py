...
class ProductHuntProvider(BaseScraperProvider):
    def __init__(self):
        super().__init__(
            platform_name="producthunt", site_domain="producthunt.com", result_pattern="producthunt.com/"
        )
    ...
    def search(
        ...
        queries = [f"site:producthunt.com {role}", f"site:producthunt.com {role} {loc}"]
        ...
        if username and password:
            for q in queries:
                ...
                try:
                            ...
                            for item in organic_results:
                                ...
                                if (
                                    ...
                                    if "Product Hunt" in name:
                                        name = name.replace("Product Hunt", "").strip()
                                    if not name:
                    ...
                    print(f"DEBUG: Oxylabs ProductHunt exception: {e}")
