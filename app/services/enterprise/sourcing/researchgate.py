...
class ResearchGateProvider(BaseScraperProvider):
    def __init__(self):
        super().__init__(
            ...
            site_domain="researchgate.net/profile/",
            result_pattern="researchgate.net/profile/",
        )
    ...
    def search(
        ...
        queries = [
            f'site:researchgate.net/profile "{role}"',
            f'site:researchgate.net/profile "{role}" "{loc}"',
        ]
        ...
        for q in queries:
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    for res in results:
                        ...
                        for item in organic_results:
                            ...
                            if url and "researchgate.net/profile/" in url:
                                url = url.split("?")[0]
                                if url in seen_urls:
                                    continue
                                seen_urls.add(url)
                                ...
                                if "ResearchGate" in name:
                                    name = name.replace("ResearchGate", "").strip()
                                if not name:
                ...
                print(f"DEBUG: Oxylabs ResearchGate exception: {e}")
