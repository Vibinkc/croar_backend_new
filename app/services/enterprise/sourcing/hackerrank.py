...
class HackerRankProvider(BaseScraperProvider):
    def __init__(self):
        super().__init__(
            platform_name="hackerrank", site_domain="hackerrank.com", result_pattern="hackerrank.com/"
        )
    ...
    def search(
        ...
        queries = [f"site:hackerrank.com/profile {role}", f"site:hackerrank.com/profile {role} {loc}"]
        ...
        if username and password:
            for q in queries:
                ...
                try:
                    ...
                    if response.status_code == 200:
                        ...
                        for res in results:
                            ...
                            for item in organic_results:
                                ...
                                if url and "hackerrank.com/profile/" in url:
                                    url = url.split("?")[0]
                                    if url in seen_urls:
                                        continue
                                    seen_urls.add(url)
                                    ...
                                    if "HackerRank" in name:
                                        name = name.replace("HackerRank", "").strip()
                                    if not name:
                    ...
                    print(f"DEBUG: Oxylabs HackerRank exception: {e}")
