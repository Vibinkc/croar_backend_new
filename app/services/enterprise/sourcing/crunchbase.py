...
class CrunchbaseProvider(BaseScraperProvider):
    def __init__(self):
        super().__init__(
            ...
            site_domain="crunchbase.com/person",
            result_pattern="crunchbase.com/person/",
        )
    ...
    def search(
        ...
        queries = [f'site:crunchbase.com/person "{role}"', f'site:crunchbase.com/person "{role}" "{loc}"']
        ...
        for q in queries:
            ...
            try:
                        ...
                        for item in organic_results:
                            ...
                            if url and "crunchbase.com/person/" in url:
                                ...
                                if "Crunchbase" in name:
                                    name = name.replace("Crunchbase", "").strip()
                                if not name:
                ...
                print(f"DEBUG: Oxylabs Crunchbase exception: {e}")
