...
class KaggleProvider(BaseScraperProvider):
    def __init__(self):
        super().__init__(platform_name="kaggle", site_domain="kaggle.com", result_pattern="kaggle.com/")
    ...
    def search(
        ...
        queries = [f"site:kaggle.com {role}", f"site:kaggle.com {role} {loc}"]
        ...
        if username and password:
            for q in queries:
                ...
                try:
                    ...
                    if response.status_code == 200:
                        ...
                        for res in results:
                            ...
                            for item in organic_results:
                                ...
                                if (
                                    url
                                    and "kaggle.com/" in url
                                    and not any(
                                        k in url for k in ["/competitions", "/discussion", "/docs/", "/code/"]
                                    )
                                ):
                                    url = url.split("?")[0]
                                    if url in seen_urls:
                    ...
                    print(f"DEBUG: Oxylabs Kaggle exception: {e}")
