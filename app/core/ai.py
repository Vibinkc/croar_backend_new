    ...
    try:
        ...
        return json.dumps({
            "issues": [{
                ...
                "improvement": f"An error occurred during AI analysis: {str(e)}", 
                "severity": "high"
            }]
        })
...
async def generate_job_description_ai(title: str, existing_description: str = "", location: str = "", experience_min: str = "", experience_max: str = "") -> Dict[str, Any]:
    """
